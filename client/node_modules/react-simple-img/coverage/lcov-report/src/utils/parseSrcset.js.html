...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/parseSrcset.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> parseSrcset.js
    </h1>
    <div class='clearfix'>
...
export default function parseSrcset(srcset: string) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!Array.isArray(sSources)) <span class="cstat-no" title="statement not covered" >throw new Error(`💩 srcset is invalid ${JSON.stringify(sSources, null, 2)}`);</span>
&nbsp;
  const sources = [];
&nbsp;
...
&nbsp;
    if (parts.length === 0 || (parts.length === 1 &amp;&amp; !parts[0]) || (parts.length === 2 &amp;&amp; !parts[0] &amp;&amp; <span class="branch-5 cbranch-no" title="branch not covered" >!parts[1])</span>) {
...
&nbsp;
    if (parts.length === 1 || (parts.length === 2 &amp;&amp; !parts[1])) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (lastChar === 'x') {
