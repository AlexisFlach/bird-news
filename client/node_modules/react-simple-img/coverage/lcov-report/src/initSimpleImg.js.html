...
<html lang="en">
<head>
    <title>Code coverage report for src/initSimpleImg.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> initSimpleImg.js
    </h1>
    <div class='clearfix'>
...
export default function initSimpleImg(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof window === 'undefined') <span class="cstat-no" title="statement not covered" >return;</span>
