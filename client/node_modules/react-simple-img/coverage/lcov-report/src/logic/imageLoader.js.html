...
<html lang="en">
<head>
    <title>Code coverage report for src/logic/imageLoader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/logic</a> imageLoader.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    fetchImage(image, src)
      .then(() =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (target) {
          applyImage(target, image, src);
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!window.__REACT_SIMPLE_IMG__) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!callback) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
          callback();
