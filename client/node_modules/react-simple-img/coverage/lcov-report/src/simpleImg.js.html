...
<html lang="en">
<head>
    <title>Code coverage report for src/simpleImg.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> simpleImg.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.92% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>56/59</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">74.12% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>63/85</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
        const cachedImagesRef = JSON.parse(cachedImagesRefString) || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
        <span class="missing-if-branch" title="else path not taken" >E</span>if (cachedImagesRef[src]) {
          this.setState({
            isCached: true,
          });
          return;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (document.readyState === 'complete') {
      this.triggerImageLoadOrObserver();
    } else {
<span class="cstat-no" title="statement not covered" >      window.addEventListener('load', this.setDocumentLoaded);</span>
    }
  }
&nbsp;
...
&nbsp;
  componentWillUnmount() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.element.current) <span class="cstat-no" title="statement not covered" >return;</span>
    const element = this.element.current;
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (onComplete) <span class="cstat-no" title="statement not covered" >callBackRefs.set(this.element.current, onComplete);</span>
  }
&nbsp;
  render() {
    const {
      ...
      srcSet,
      applyAspectRatio,
      animationDuration = <span class="branch-0 cbranch-no" title="branch not covered" >0.3,</span>
      placeholder = <span class="branch-0 cbranch-no" title="branch not covered" >defaultPlaceholderColor,</span>
      style = {},
      ...restProps
    } = this.props;
    ...
    const heightWidth = {
      ...(height ? <span class="branch-0 cbranch-no" title="branch not covered" >{ height: style.height || height } </span>: null),
      ...(width ? <span class="branch-0 cbranch-no" title="branch not covered" >{ width: style.width || width } </span>: null),
    };
        ...
        &lt;React.Fragment&gt;
          ...
          &lt;img
            style={{
              ...style,
              ...(isCached
                ? <span class="branch-0 cbranch-no" title="branch not covered" >null</span>
                : {
                    transition: `${animationDuration}s opacity`,
                    opacity: 0,
                  }),
    ...
    if (isCached) {
      return (
        &lt;div
          style={{
            ...(shouldUseAspectRatio
              ? <span class="branch-0 cbranch-no" title="branch not covered" >aspectRatioStyle</span>
              : {
                  ...heightWidth,
                  ...wrapperCommonStyle,
                  ...style,
        ...
        &gt;
          &lt;img
            style={{
              ...(isHeightAndWidthNotSet ? expendWidth : <span class="branch-1 cbranch-no" title="branch not covered" >heightWidth)</span>,
              ...(shouldUseAspectRatio ? <span class="branch-0 cbranch-no" title="branch not covered" >aspectRatioChildStyle </span>: null),
              ...imgStyle,
            }}
            {...imageProps}
          /&gt;
      ...
      &lt;div
        style={{
          ...(shouldUseAspectRatio
            ...
            : {
                ...wrapperCommonStyle,
                ...(height ? <span class="branch-0 cbranch-no" title="branch not covered" >{ height } </span>: { height: 1, visibility: 'hidden' }),
                ...style,
              }),
        }}
        className={className}
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Dec 30 2019 09:35:59 GMT+1100 (AEDT)
</div>
</div>
